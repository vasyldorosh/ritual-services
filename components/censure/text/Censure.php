<?php
namespace app\components\censure\text;

use app\components\censure\ReflectionTypeHint;
use app\components\censure\UTF8;
...
class Censure
{
	...
	public static function parse($s, $delta = 3, $continue = "\xe2\x80\xa6", $is_html = true, $replace = null, $charset = 'UTF-8')
	{
